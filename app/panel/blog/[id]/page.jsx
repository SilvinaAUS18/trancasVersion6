    ...
    <section className="container mx-20">
      {blogDetails?.authorId?._id.toString() ===
        ...
        <div className="flex items-center justify-end gap-5">
          <Link
            href={`/panel/blog/edit/${params.id}`}
      ...
      <div className="flex flex-col items-center justify-center">
        <Link href={`/panel/user/${blogDetails?.authorId?._id.toString()}`}>
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-justify">{blogDetails?.excerpt}...</p>
      ...
      <Link href="/panel/blog"  className="text-blue-700 text-lg"> Volver al panel </Link>
